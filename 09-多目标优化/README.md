...
| 章节 | 内容 | 建议 |
|------|------|------|
| 01-multiobj-bg | 多目标优化概览 | 必读 |
| 01-multiobj-bg §1.5 | 建模心法 | 强烈建议 |
| 02-methods §2.1~2.6 | 核心方法 | 必读 |

> **Step 3 — 案例实战**（可跳到感兴趣的案例直接读）

| 章节 | 内容 | 难度 | 目标 |
|------|------|------|------|
| 03-case | 投资组合 | ★★☆☆☆ | 收益 vs 风险 |
| 04-case | 产品设计 | ★★★☆☆ | 成本 vs 性能 vs 重量 |
| 05-case | 生产调度 | ★★★☆☆ | 完工时间 vs 成本 vs 能耗 |
| 06-case | 供应链 | ★★★★☆ | 成本 vs 服务 vs 碳排放 |
| 07-case | NSGA-II | ★★★★☆ | 进阶：从零实现 |
...
| 凸优化与非线性优化 | 本课程关心“多个目标怎么权衡”，凸优化课程关心“单个连续优化子问题怎么可靠求解”；投资组合可先读 `../10-凸优化与非线性优化/lectures/04-case-portfolio-qp.md` 再读本课案例 1 |
